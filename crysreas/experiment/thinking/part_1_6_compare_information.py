"""
Run EXPERIMENT §1.6: backend (data) then frontend (figure).
"""
...
from .part_1_6_backend import run as run_backend
from .part_1_6_frontend import run as run_frontend
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run EXPERIMENT §1.6 (backend + frontend).")
