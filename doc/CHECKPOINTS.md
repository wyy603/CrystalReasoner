...
| `rl_elastic_thinking_new` | [🤗 Qwen2.5-3B-CrysReas-ElasticElasticProperties](https://huggingface.co/CrystalReasoner/Qwen2.5-3B-CrysReas-ElasticProperties) | Elastic-property specialist. |
