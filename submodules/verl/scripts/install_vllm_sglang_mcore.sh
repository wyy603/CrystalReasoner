...
#pip install --no-cache-dir ../flash_attn-2.8.3+cu12torch2.8cxx11abiTRUE-cp312-cp312-linux_x86_64.whl
#pip install --no-cache-dir flashinfer-python==0.3.1

# echo "3. install FlashAttention and FlashInfer (Python 3.10)"
